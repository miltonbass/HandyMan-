...
namespace HandyMan_.Backend.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("0001", "Israel", "Carreño", "isra@yopmail.com", "318 4756753", "Avenida siempre viva 123", "isra.jpg", UserType.Admin);
            await CheckUserAsync("0002", "User1", "Asisstant", "asistant@yopmail.com", "111 111 111", "Avenida 2", "user1.jpg", UserType.UserPremium);
            await CheckUserAsync("0003", "User2", "Free", "free@yopmail.com", "322 311 4620", "Avenida 3", "User2.jpg", UserType.User);
